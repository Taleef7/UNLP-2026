...
\end{axis}
\end{tikzpicture}
\caption{Local full-dev vs.\ Kaggle public composite. sg\,=\,structure-guard (\S\ref{sec:gap}). Only v7 lies above the $y{=}x$ diagonal; all other systems regressed. Horizontal bars: 95\% bootstrap CI on local composite for v13 and v14; v13's interval overlaps the v7 reference (dotted), confirming it was never a decisive offline win.}
\label{fig:gap}
\end{figure}
